...
def create_weak_kernels(X_train, X_test=None, max_features=5, num_kernels=3, max_degree=3):
    """
    ...
    Parameters:
        ...
        max_features (int): Maximum number of selected features per kernel.
    ...
    for _ in range(num_kernels):
        ...
        index_columns = np.random.randint(
            0,
            X_train.shape[1],
